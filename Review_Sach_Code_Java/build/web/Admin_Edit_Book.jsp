                                                    ...
                                                    <div class="review-content-section">
                                                        <c:forEach items="${pro}" var="item">
                                                            <div class="input-group mg-b-pro-edt">
                                                                ...
                                                                <input type="text" class="form-control" value="${item.getName()}" placeholder="${item.getName()}">
                                                            </div>
                                                            <div class="input-group mg-b-pro-edt">
                                                                <span class="input-group-addon"><i class="fa-solid fa-circle-info"></i></span>
                                                                <input type="text" class="form-control" value="${item.getContent()}" placeholder="${item.getContent()}">
                                                            </div>
                                                            <select name="select" class="form-control pro-edt-select form-control-primary">
                                                                <option value="0">${item.getCatId()} (default)</option>
                                                                <c:forEach items="${cate}" var="items">
                                                                    <option value="${items.getProId()}">${items.getName()}</option>
                                                                </c:forEach>
                                                            </select>
                                                        </c:forEach>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <input type="file" class="form-control" accept="image/png, image/jpeg" onchange="previewImage(event)">
                                                        </div>
                                                        <c:forEach items="${pro}" var="item">
                                                            <div id="imagePreview" src="img/book/image1.jpg"></div>
                                                            <image src="img/book/${item.getImage()}" />
                                                        </c:forEach>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="text-center custom-pro-edt-ds" style="margin-top: 20px">
                                                        ...
                                                        <button type="button" class="btn btn-ctl-bt waves-effect waves-light">Return
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
