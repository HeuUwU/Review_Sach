                                    ...
                                    <table>
                                        ...
                                        <c:forEach items="${cusList}" var="item">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="customer?id=${item.getCusId()}&status=${item.getStatus()}" class="${item.getStatus() ? 'pd-setting' : 'ds-setting'}" onclick="toggleStatus(this, ${item.getStatus()})">
                                                        ${item.getStatus() ? '<i class="fa-solid fa-lock-open"></i>' : '<i class="fa-solid fa-lock"></i>'}
                                                    </a>
                                                </td>
